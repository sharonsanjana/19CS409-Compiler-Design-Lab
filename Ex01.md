...
// Function to reset the hash map
...
// Function to check which states are present in the e-closure
...
// Function to find new closure states
...
// Function to pick the next closure from closure set
...
// Function to check if new DFA states can be entered in DFA table
...
// Function to check new states in DFA
...
// Function to display DFA transition state table
...
int main() {
    int i, j, states;
    char T_buf[MAX_LEN];
    struct DFA *dfa_states = malloc(MAX_LEN * sizeof(struct DFA));
    states = 6;
    symbols = 2;
    printf("\n STATES OF NFA :\t\t");
    for (i = 0; i < states; i++)
    ...
    char closure_table[states][MAX_LEN];
...
## OUTPUT 
![image](https://github.com/Catty12384/19CS409-Compiler-Design-Lab/assets/120629225/45c07cf2-6294-4f18-8d57-93209c880ca5)
